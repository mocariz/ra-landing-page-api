...
ALTER TABLE IF EXISTS ONLY public.components_page_section_models_components DROP CONSTRAINT IF EXISTS components_page_section_model_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.components_page_princing_boxes_components DROP CONSTRAINT IF EXISTS components_page_princing_box_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.components_page_section_models DROP CONSTRAINT IF EXISTS components_page_section_models_pkey;
ALTER TABLE IF EXISTS ONLY public.components_page_section_models_components DROP CONSTRAINT IF EXISTS components_page_section_models_components_pkey;
...
ALTER TABLE IF EXISTS ONLY public.components_page_princing_boxes DROP CONSTRAINT IF EXISTS components_page_princing_boxes_pkey;
ALTER TABLE IF EXISTS ONLY public.components_page_princing_boxes_components DROP CONSTRAINT IF EXISTS components_page_princing_boxes_components_pkey;
...
ALTER TABLE IF EXISTS ONLY public.components_page_models DROP CONSTRAINT IF EXISTS components_page_models_pkey;
...
ALTER TABLE IF EXISTS public.components_page_section_models_components ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.components_page_section_models ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.components_page_princing_boxes_components ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.components_page_princing_boxes ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.components_page_models ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.components_page_section_models_id_seq;
DROP SEQUENCE IF EXISTS public.components_page_section_models_components_id_seq;
DROP TABLE IF EXISTS public.components_page_section_models_components;
DROP TABLE IF EXISTS public.components_page_section_models;
...
DROP SEQUENCE IF EXISTS public.components_page_princing_boxes_id_seq;
DROP SEQUENCE IF EXISTS public.components_page_princing_boxes_components_id_seq;
DROP TABLE IF EXISTS public.components_page_princing_boxes_components;
DROP TABLE IF EXISTS public.components_page_princing_boxes;
...
DROP SEQUENCE IF EXISTS public.components_page_models_id_seq;
DROP TABLE IF EXISTS public.components_page_models;
...
--
-- Name: components_page_models; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.components_page_models (
    id integer NOT NULL,
    title character varying(255),
    subtitle text,
    description text
...
ALTER TABLE public.components_page_models OWNER TO strapi;

--
-- Name: components_page_models_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.components_page_models_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.components_page_models_id_seq OWNER TO strapi;

--
-- Name: components_page_models_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.components_page_models_id_seq OWNED BY public.components_page_models.id;
...
--
-- Name: components_page_princing_boxes; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.components_page_princing_boxes (
    id integer NOT NULL,
    "totalPrice" integer,
...
ALTER TABLE public.components_page_princing_boxes OWNER TO strapi;

--
-- Name: components_page_princing_boxes_components; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.components_page_princing_boxes_components (
    id integer NOT NULL,
    field character varying(255) NOT NULL,
    "order" integer NOT NULL,
    component_type character varying(255) NOT NULL,
    component_id integer NOT NULL,
    components_page_princing_box_id integer NOT NULL
);


ALTER TABLE public.components_page_princing_boxes_components OWNER TO strapi;

--
-- Name: components_page_princing_boxes_components_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.components_page_princing_boxes_components_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.components_page_princing_boxes_components_id_seq OWNER TO strapi;

--
-- Name: components_page_princing_boxes_components_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.components_page_princing_boxes_components_id_seq OWNED BY public.components_page_princing_boxes_components.id;


--
-- Name: components_page_princing_boxes_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.components_page_princing_boxes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.components_page_princing_boxes_id_seq OWNER TO strapi;

--
-- Name: components_page_princing_boxes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.components_page_princing_boxes_id_seq OWNED BY public.components_page_princing_boxes.id;
...
--
-- Name: components_page_section_models; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.components_page_section_models (
    id integer NOT NULL,
    title character varying(255)
);


ALTER TABLE public.components_page_section_models OWNER TO strapi;

--
-- Name: components_page_section_models_components; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.components_page_section_models_components (
    id integer NOT NULL,
    field character varying(255) NOT NULL,
    "order" integer NOT NULL,
    component_type character varying(255) NOT NULL,
    component_id integer NOT NULL,
    components_page_section_model_id integer NOT NULL
);


ALTER TABLE public.components_page_section_models_components OWNER TO strapi;

--
-- Name: components_page_section_models_components_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.components_page_section_models_components_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.components_page_section_models_components_id_seq OWNER TO strapi;

--
-- Name: components_page_section_models_components_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.components_page_section_models_components_id_seq OWNED BY public.components_page_section_models_components.id;


--
-- Name: components_page_section_models_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.components_page_section_models_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.components_page_section_models_id_seq OWNER TO strapi;

--
-- Name: components_page_section_models_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.components_page_section_models_id_seq OWNED BY public.components_page_section_models.id;
...
--
-- Name: components_page_models id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_models ALTER COLUMN id SET DEFAULT nextval('public.components_page_models_id_seq'::regclass);
...
--
-- Name: components_page_princing_boxes id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_princing_boxes ALTER COLUMN id SET DEFAULT nextval('public.components_page_princing_boxes_id_seq'::regclass);


--
-- Name: components_page_princing_boxes_components id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_princing_boxes_components ALTER COLUMN id SET DEFAULT nextval('public.components_page_princing_boxes_components_id_seq'::regclass);
...
--
-- Name: components_page_section_models id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_section_models ALTER COLUMN id SET DEFAULT nextval('public.components_page_section_models_id_seq'::regclass);


--
-- Name: components_page_section_models_components id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_section_models_components ALTER COLUMN id SET DEFAULT nextval('public.components_page_section_models_components_id_seq'::regclass);
...
5	Guilherme Louro	Instrutor	2020-07-17 22:14:54.114-03	2020-11-21 20:19:28.357-03	Desenvolvedor Fullstack há muitos anos, com conhecimento em diversas linguagens de programação. Já liderou grandes projetos e trabalha atualmente na Personare, um dos maiores portais de autoconhecimento do Brasil. Nas horas vagas é o criador e mantenedor do Netfla, site de notícias do Flamengo com mais de meio milhão de views por mês!	2020-07-17 22:14:54.114-03	\N	1
4	Willian Justen	Instrutor	2020-07-17 22:14:17.25-03	2020-11-21 20:20:02.27-03	Desenvolvedor Front-end há mais de 10 anos, tendo trabalhado em grandes empresas como Toptal, Globo.com e Huge. Tenho um blog com mais de 200 mil views por mês, além de ter diversos cursos na Udemy, alcançando a incrível marca de mais de 200 mil alunos!	2020-07-17 22:14:17.25-03	\N	1
7	Marcos Oliveira	Designer	2020-07-17 23:58:45.155-03	2020-11-21 20:20:39.421-03	Front-End e UI Designer há alguns anos. Atualmente trabalha na Lukin Co. Já participou de diversos tipos de projetos, na área da saúde, streaming e varejo. Sempre dividido entre design e programação. No tempo livre sempre está envolvido com a comunidade, organizando eventos e meetups.	2020-07-17 23:58:45.155-03	\N	1
\.
...
3	Comprar o curso	https://www.udemy.com/course/react-avancado/?couponCode=PROMONOV20
\.
...
--
-- Data for Name: components_page_models; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.components_page_models (id, title, subtitle, description) FROM stdin;
\.
...
--
-- Data for Name: components_page_princing_boxes; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.components_page_princing_boxes (id, "totalPrice", "numberInstallments", "priceInstallments", benefits, "priceInstallment") FROM stdin;
1	415	6	\N	<ul><li>Acesso aos <strong>6 módulos</strong> assim que lançados</li><li>Código de <strong>todo o projeto</strong> separado em commits</li><li>Contato <strong>direto</strong> com os instrutores via Slack</li><li><strong>Lives exclusivas</strong> durante o curso</li></ul>	48
\.


--
-- Data for Name: components_page_princing_boxes_components; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.components_page_princing_boxes_components (id, field, "order", component_type, component_id, components_page_princing_box_id) FROM stdin;
...
COPY public.components_page_reviews (id, name, text, content) FROM stdin;
1	Henrique Albert Schmaiske	O Curso foi incrível! Gostei muito das explicações, bem claras e objetivas! Deixo a sugestão para um próximo Curso: NextJS mostrando fazer um Ecommerce. Compraria sem nem olhar o preço.	\N
2	Alexandre Teixeira	Esse já é o terceiro curso do Will que faço, e a didática do cara é incrível! Além disso, o cara segue trazendo o que tem de mais moderno no mercado de forma bem explicada e com aplicações práticas.	\N
3	Daniel P. de Oliveira	É incrível a forma como foi passado o conteúdo do curso, dá para ver que o Will tem um domínio impressionante sobre as ferramentas e tecnologias passadas, e mesmo eu tendo pouco conhecimento em React consegui acompanhar o curso sem muitas dificuldades. Espero que tenha mais cursos nessa linha, com certeza comprarei! Obrigado Will!	\N
4	Mileine Souto	Sensacional! A didática do instrutor é excelente para estruturar o curso e dar o ritmo das aulas. Foi uma experiência muito enriquecedora (e divertida) construir um blog seguindo o passo-a-passo dos vídeos. Não sabia nada sobre Gatsby, GraphQL ou Netlify CMS mas consegui acompanhar todo o processo sem grandes dificuldades. Além disso, foi ótimo aprender um pouquinho mais sobre algumas práticas de desenvolvimento, como temas em React, estilização CSS in JS com styled-components e utilização do Algolia como solução de busca. Recomendo! =)	\N
\.
...
--
-- Data for Name: components_page_section_models; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.components_page_section_models (id, title) FROM stdin;
\.


--
-- Data for Name: components_page_section_models_components; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.components_page_section_models_components (id, field, "order", component_type, component_id, components_page_section_model_id) FROM stdin;
\.
...
16	Dribble	http://vmarcosp.dribbble.com/
...
COPY public.components_page_tech_icons (id, title, name) FROM stdin;
...
6	GraphQL	GraphQL
7	Jest	Jest
8	Testing Library	Testing Library
...
67	model_def_page.review	{"uid":"page.review","collectionName":"components_page_reviews","info":{"name":"review","icon":"star-half-alt","description":""},"options":{"timestamps":false},"attributes":{"name":{"type":"string","required":true},"photo":{"model":"file","via":"related","allowedTypes":["images"],"plugin":"upload","required":false},"text":{"type":"text","required":true}}}	object	\N	\N
63	model_def_page.header	{"uid":"page.header","collectionName":"components_page_headers","info":{"name":"header","icon":"heading"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"description":{"type":"text","required":true},"button":{"type":"component","repeatable":false,"component":"page.button"},"image":{"model":"file","via":"related","allowedTypes":["images"],"plugin":"upload","required":true}}}	object	\N	\N
...
65	model_def_page.princing-box	{"uid":"page.princing-box","collectionName":"components_page_princing_boxes","info":{"name":"princingBox","icon":"dollar-sign","description":""},"options":{"timestamps":false},"attributes":{"totalPrice":{"type":"integer","required":true,"default":415},"numberInstallments":{"type":"integer","required":true,"default":6},"priceInstallment":{"type":"integer","required":true,"default":48},"benefits":{"type":"richtext","required":true},"button":{"type":"component","repeatable":false,"component":"page.button","required":true}}}	object	\N	\N
...
64	model_def_page.models	{"uid":"page.models","collectionName":"components_page_models","info":{"name":"models","icon":"audio-description"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"subtitle":{"type":"text","required":true},"description":{"type":"richtext","required":true}}}	object	\N	\N
68	model_def_page.section-about-project	{"uid":"page.section-about-project","collectionName":"components_page_section_about_projects","info":{"name":"sectionAboutProject","icon":"info"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"media":{"model":"file","via":"related","allowedTypes":["images","videos"],"plugin":"upload","required":true},"description":{"type":"richtext","required":true}}}	object	\N	\N
70	model_def_page.section-agenda	{"uid":"page.section-agenda","collectionName":"components_page_section_agenda","info":{"name":"sectionAgenda","icon":"calendar-day"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"description":{"type":"richtext","required":true}}}	object	\N	\N
71	model_def_page.section-concepts	{"uid":"page.section-concepts","collectionName":"components_page_section_concepts","info":{"name":"sectionConcepts","icon":"align-justify"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"concepts":{"type":"component","repeatable":true,"component":"page.concepts"}}}	object	\N	\N
72	model_def_page.section-faq	{"uid":"page.section-faq","collectionName":"components_page_section_faqs","info":{"name":"sectionFaq","icon":"align-right"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"questions":{"type":"component","repeatable":true,"component":"page.questions","required":true}}}	object	\N	\N
74	model_def_page.section-reviews	{"uid":"page.section-reviews","collectionName":"components_page_section_reviews","info":{"name":"sectionReviews","icon":"star","description":""},"options":{"timestamps":false},"attributes":{"title":{"type":"text","unique":false,"required":true},"reviews":{"type":"component","repeatable":true,"component":"page.reviews","required":true}}}	object	\N	\N
75	model_def_page.section-tech	{"uid":"page.section-tech","collectionName":"components_page_section_teches","info":{"name":"sectionTech","icon":"ad","description":""},"options":{"timestamps":false},"attributes":{"title":{"type":"string"},"techIcons":{"type":"component","repeatable":true,"component":"page.tech-icons"}}}	object	\N	\N
73	model_def_page.section-models	{"uid":"page.section-models","collectionName":"components_page_section_models","info":{"name":"sectionModels","icon":"atlas"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"modules":{"type":"component","repeatable":true,"component":"page.models","required":true}}}	object	\N	\N
69	model_def_page.section-about-us	{"uid":"page.section-about-us","collectionName":"components_page_section_aboutuses","info":{"name":"sectionAboutUs","icon":"user-astronaut"},"options":{"timestamps":false},"attributes":{"title":{"type":"text","required":true},"authors":{"collection":"author","attribute":"author","column":"id","isVirtual":true}}}	object	\N	\N
...
77	model_def_page.tech-icons	{"uid":"page.tech-icons","collectionName":"components_page_tech_icons","info":{"name":"techIcons","icon":"window-maximize"},"options":{"timestamps":false},"attributes":{"name":{"type":"string","required":true},"icon":{"model":"file","via":"related","allowedTypes":["images"],"plugin":"upload","required":true}}}	object	\N	\N
...
22	plugin_content_manager_configuration_content_types::application::landing-page.landing-page	{"uid":"application::landing-page.landing-page","settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"id","defaultSortBy":"id","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"Id","searchable":true,"sortable":true}},"logo":{"edit":{"label":"Logo","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Logo","searchable":false,"sortable":false}},"header":{"edit":{"label":"Header","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Header","searchable":false,"sortable":false}},"sectionAboutProject":{"edit":{"label":"SectionAboutProject","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"SectionAboutProject","searchable":false,"sortable":false}},"sectionTech":{"edit":{"label":"SectionTech","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"SectionTech","searchable":false,"sortable":false}},"sectionConcepts":{"edit":{"label":"SectionConcepts","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"SectionConcepts","searchable":false,"sortable":false}},"sectionModules":{"edit":{"label":"SectionModules","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"SectionModules","searchable":false,"sortable":false}},"sectionAgenda":{"edit":{"label":"SectionAgenda","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"SectionAgenda","searchable":false,"sortable":false}},"princingBox":{"edit":{"label":"PrincingBox","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"PrincingBox","searchable":false,"sortable":false}},"sectionAboutUs":{"edit":{"label":"SectionAboutUs","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"SectionAboutUs","searchable":false,"sortable":false}},"sectionReviews":{"edit":{"label":"SectionReviews","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"SectionReviews","searchable":false,"sortable":false}},"sectionFaq":{"edit":{"label":"SectionFaq","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"SectionFaq","searchable":false,"sortable":false}},"published_at":{"edit":{"label":"Published_at","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"Published_at","searchable":true,"sortable":true}},"created_at":{"edit":{"label":"Created_at","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"Created_at","searchable":true,"sortable":true}},"updated_at":{"edit":{"label":"Updated_at","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"Updated_at","searchable":true,"sortable":true}}},"layouts":{"list":["id","logo","created_at","updated_at"],"edit":[[{"name":"logo","size":6}],[{"name":"header","size":12}],[{"name":"sectionAboutProject","size":12}],[{"name":"sectionTech","size":12}],[{"name":"sectionConcepts","size":12}],[{"name":"sectionModules","size":12}],[{"name":"sectionAgenda","size":12}],[{"name":"sectionAboutUs","size":12}],[{"name":"sectionReviews","size":12}],[{"name":"sectionFaq","size":12}],[{"name":"princingBox","size":12}]],"editRelations":[]}}	object		
91	plugin_content_manager_configuration_components::page.models	{"uid":"page.models","isComponent":true,"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"title","defaultSortBy":"title","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"Id","searchable":false,"sortable":false}},"title":{"edit":{"label":"Title","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Title","searchable":true,"sortable":true}},"subtitle":{"edit":{"label":"Subtitle","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Subtitle","searchable":true,"sortable":true}},"description":{"edit":{"label":"Description","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Description","searchable":false,"sortable":false}}},"layouts":{"list":["id","title","subtitle"],"edit":[[{"name":"title","size":6},{"name":"subtitle","size":6}],[{"name":"description","size":12}]],"editRelations":[]}}	object		
47	plugin_content_manager_configuration_content_types::application::author.author	{"uid":"application::author.author","settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"name","defaultSortBy":"name","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"Id","searchable":true,"sortable":true}},"avatar":{"edit":{"label":"Avatar","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Avatar","searchable":false,"sortable":false}},"name":{"edit":{"label":"Name","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Name","searchable":true,"sortable":true}},"role":{"edit":{"label":"Role","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Role","searchable":true,"sortable":true}},"description":{"edit":{"label":"Description","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Description","searchable":false,"sortable":false}},"socialLinks":{"edit":{"label":"SocialLinks","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"SocialLinks","searchable":false,"sortable":false}},"published_at":{"edit":{"label":"Published_at","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"Published_at","searchable":true,"sortable":true}},"created_at":{"edit":{"label":"Created_at","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"Created_at","searchable":true,"sortable":true}},"updated_at":{"edit":{"label":"Updated_at","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"Updated_at","searchable":true,"sortable":true}}},"layouts":{"list":["id","name","role","avatar"],"edit":[[{"name":"name","size":6}],[{"name":"role","size":6}],[{"name":"socialLinks","size":12}],[{"name":"description","size":12}],[{"name":"avatar","size":6}]],"editRelations":[]}}	object		
32	plugin_content_manager_configuration_components::page.tech-icons	{"uid":"page.tech-icons","isComponent":true,"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"name","defaultSortBy":"name","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"Id","searchable":false,"sortable":false}},"name":{"edit":{"label":"Name","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Name","searchable":true,"sortable":true}},"icon":{"edit":{"label":"Icon","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Icon","searchable":false,"sortable":false}}},"layouts":{"list":["id","icon","name"],"edit":[[{"name":"icon","size":6},{"name":"name","size":6}]],"editRelations":[]}}	object		
...
28	plugin_content_manager_configuration_components::page.section-about-project	{"uid":"page.section-about-project","isComponent":true,"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"title","defaultSortBy":"title","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"Id","searchable":false,"sortable":false}},"title":{"edit":{"label":"Title","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Title","searchable":true,"sortable":true}},"media":{"edit":{"label":"Media","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Media","searchable":false,"sortable":false}},"description":{"edit":{"label":"Description","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Description","searchable":false,"sortable":false}}},"layouts":{"list":["id","title","media"],"edit":[[{"name":"title","size":6}],[{"name":"description","size":12}],[{"name":"media","size":6}]],"editRelations":[]}}	object		
...
92	plugin_content_manager_configuration_components::page.princing-box	{"uid":"page.princing-box","isComponent":true,"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"id","defaultSortBy":"id","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"Id","searchable":false,"sortable":false}},"totalPrice":{"edit":{"label":"TotalPrice","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"TotalPrice","searchable":true,"sortable":true}},"numberInstallments":{"edit":{"label":"NumberInstallments","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"NumberInstallments","searchable":true,"sortable":true}},"priceInstallment":{"edit":{"label":"PriceInstallment","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"PriceInstallment","searchable":true,"sortable":true}},"benefits":{"edit":{"label":"Benefits","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Benefits","searchable":false,"sortable":false}},"button":{"edit":{"label":"Button","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Button","searchable":false,"sortable":false}}},"layouts":{"list":["id","totalPrice","numberInstallments","priceInstallment"],"edit":[[{"name":"totalPrice","size":4},{"name":"numberInstallments","size":4}],[{"name":"benefits","size":12}],[{"name":"button","size":12}],[{"name":"priceInstallment","size":4}]],"editRelations":[]}}	object		
95	model_def_page.section-modules	{"uid":"page.section-modules","collectionName":"components_page_section_modules","info":{"name":"sectionModules","icon":"align-center"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"modules":{"type":"component","repeatable":true,"component":"page.modules","required":true}}}	object	\N	\N
76	model_def_page.social-links	{"uid":"page.social-links","collectionName":"components_page_social_links","info":{"name":"socialLinks","icon":"medal"},"options":{"timestamps":false},"attributes":{"url":{"type":"text","required":true},"title":{"type":"enumeration","enum":["Github","Twitter","Dribble","LinkedIn","Facebook"],"default":"Github","required":true}}}	object	\N	\N
78	model_def_application::author.author	{"uid":"application::author.author","collectionName":"authors","kind":"collectionType","info":{"name":"author"},"options":{"increments":true,"timestamps":["created_at","updated_at"],"draftAndPublish":true},"attributes":{"avatar":{"model":"file","via":"related","allowedTypes":["images"],"plugin":"upload","required":true},"name":{"type":"string","required":true},"role":{"type":"string","required":true},"description":{"type":"richtext","required":true},"socialLinks":{"type":"component","repeatable":true,"component":"page.social-links","required":true},"published_at":{"type":"datetime","configurable":false},"created_by":{"model":"user","plugin":"admin","configurable":false,"writable":false,"private":true},"updated_by":{"model":"user","plugin":"admin","configurable":false,"writable":false,"private":true}}}	object	\N	\N
...
100	plugin_content_manager_configuration_components::page.section-modules	{"uid":"page.section-modules","isComponent":true,"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"title","defaultSortBy":"title","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"Id","searchable":false,"sortable":false}},"title":{"edit":{"label":"Title","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Title","searchable":true,"sortable":true}},"modules":{"edit":{"label":"Modules","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Modules","searchable":false,"sortable":false}}},"layouts":{"list":["id","title"],"edit":[[{"name":"title","size":6}],[{"name":"modules","size":12}]],"editRelations":[]}}	object		
98	model_def_page.modules	{"uid":"page.modules","collectionName":"components_page_modules","info":{"name":"modules","icon":"address-card"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"subtitle":{"type":"string","required":true},"description":{"type":"richtext","required":true}}}	object	\N	\N
101	model_def_page.reviews	{"uid":"page.reviews","collectionName":"components_page_reviews","info":{"name":"reviews","icon":"apple-alt"},"options":{"timestamps":false},"attributes":{"name":{"type":"string","required":true},"text":{"type":"text","required":true},"photo":{"model":"file","via":"related","allowedTypes":["images"],"plugin":"upload","required":true}}}	object	\N	\N
99	plugin_content_manager_configuration_components::page.modules	{"uid":"page.modules","isComponent":true,"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"title","defaultSortBy":"title","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"Id","searchable":false,"sortable":false}},"title":{"edit":{"label":"Title","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Title","searchable":true,"sortable":true}},"subtitle":{"edit":{"label":"Subtitle","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Subtitle","searchable":true,"sortable":true}},"description":{"edit":{"label":"Description","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Description","searchable":false,"sortable":false}}},"layouts":{"list":["id","title","subtitle"],"edit":[[{"name":"title","size":6},{"name":"subtitle","size":6}],[{"name":"description","size":12}]],"editRelations":[]}}	object		
...
1	2020-07-17 22:41:34.291-03	2020-11-21 20:56:10.099-03	\N	2020-11-21 20:56:09.919-03	\N	1
\.
...
11	princingBox	1	components_page_princing_boxes	1	1
...
1	plugins::upload.read	\N	\N	[]	2	2020-11-19 19:17:40.232-03	2020-11-19 19:17:40.247-03
2	plugins::upload.assets.create	\N	\N	[]	2	2020-11-19 19:17:40.233-03	2020-11-19 19:17:40.247-03
3	plugins::upload.assets.update	\N	\N	[]	2	2020-11-19 19:17:40.233-03	2020-11-19 19:17:40.247-03
4	plugins::upload.assets.download	\N	\N	[]	2	2020-11-19 19:17:40.233-03	2020-11-19 19:17:40.248-03
5	plugins::upload.assets.copy-link	\N	\N	[]	2	2020-11-19 19:17:40.233-03	2020-11-19 19:17:40.248-03
6	plugins::upload.read	\N	\N	["admin::is-creator"]	3	2020-11-19 19:17:40.275-03	2020-11-19 19:17:40.288-03
7	plugins::upload.assets.create	\N	\N	[]	3	2020-11-19 19:17:40.276-03	2020-11-19 19:17:40.288-03
8	plugins::upload.assets.update	\N	\N	["admin::is-creator"]	3	2020-11-19 19:17:40.276-03	2020-11-19 19:17:40.288-03
9	plugins::upload.assets.download	\N	\N	[]	3	2020-11-19 19:17:40.276-03	2020-11-19 19:17:40.288-03
10	plugins::upload.assets.copy-link	\N	\N	[]	3	2020-11-19 19:17:40.276-03	2020-11-19 19:17:40.288-03
11	plugins::content-manager.explorer.create	plugins::users-permissions.user	["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role"]	[]	1	2020-11-19 19:17:40.333-03	2020-11-19 19:17:40.361-03
12	plugins::content-manager.explorer.read	plugins::users-permissions.user	["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role"]	[]	1	2020-11-19 19:17:40.334-03	2020-11-19 19:17:40.361-03
13	plugins::content-manager.explorer.update	plugins::users-permissions.user	["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role"]	[]	1	2020-11-19 19:17:40.334-03	2020-11-19 19:17:40.361-03
14	plugins::content-manager.explorer.delete	plugins::users-permissions.user	\N	[]	1	2020-11-19 19:17:40.334-03	2020-11-19 19:17:40.361-03
15	plugins::content-type-builder.read	\N	\N	[]	1	2020-11-19 19:17:40.335-03	2020-11-19 19:17:40.362-03
16	plugins::upload.read	\N	\N	[]	1	2020-11-19 19:17:40.335-03	2020-11-19 19:17:40.362-03
17	plugins::upload.assets.create	\N	\N	[]	1	2020-11-19 19:17:40.335-03	2020-11-19 19:17:40.362-03
18	plugins::upload.assets.update	\N	\N	[]	1	2020-11-19 19:17:40.335-03	2020-11-19 19:17:40.362-03
19	plugins::upload.assets.download	\N	\N	[]	1	2020-11-19 19:17:40.335-03	2020-11-19 19:17:40.362-03
20	plugins::upload.assets.copy-link	\N	\N	[]	1	2020-11-19 19:17:40.336-03	2020-11-19 19:17:40.362-03
21	plugins::upload.settings.read	\N	\N	[]	1	2020-11-19 19:17:40.405-03	2020-11-19 19:17:40.438-03
22	plugins::content-manager.single-types.configure-view	\N	\N	[]	1	2020-11-19 19:17:40.411-03	2020-11-19 19:17:40.443-03
23	plugins::content-manager.collection-types.configure-view	\N	\N	[]	1	2020-11-19 19:17:40.411-03	2020-11-19 19:17:40.443-03
24	plugins::content-manager.components.configure-layout	\N	\N	[]	1	2020-11-19 19:17:40.411-03	2020-11-19 19:17:40.443-03
25	plugins::users-permissions.roles.create	\N	\N	[]	1	2020-11-19 19:17:40.411-03	2020-11-19 19:17:40.444-03
26	plugins::users-permissions.roles.read	\N	\N	[]	1	2020-11-19 19:17:40.411-03	2020-11-19 19:17:40.444-03
27	plugins::users-permissions.roles.update	\N	\N	[]	1	2020-11-19 19:17:40.412-03	2020-11-19 19:17:40.444-03
28	plugins::users-permissions.roles.delete	\N	\N	[]	1	2020-11-19 19:17:40.412-03	2020-11-19 19:17:40.444-03
29	plugins::users-permissions.providers.read	\N	\N	[]	1	2020-11-19 19:17:40.412-03	2020-11-19 19:17:40.444-03
30	plugins::users-permissions.providers.update	\N	\N	[]	1	2020-11-19 19:17:40.42-03	2020-11-19 19:17:40.453-03
31	plugins::users-permissions.email-templates.read	\N	\N	[]	1	2020-11-19 19:17:40.487-03	2020-11-19 19:17:40.509-03
32	plugins::users-permissions.email-templates.update	\N	\N	[]	1	2020-11-19 19:17:40.493-03	2020-11-19 19:17:40.52-03
33	plugins::users-permissions.advanced-settings.read	\N	\N	[]	1	2020-11-19 19:17:40.493-03	2020-11-19 19:17:40.52-03
34	plugins::users-permissions.advanced-settings.update	\N	\N	[]	1	2020-11-19 19:17:40.494-03	2020-11-19 19:17:40.52-03
35	admin::marketplace.read	\N	\N	[]	1	2020-11-19 19:17:40.494-03	2020-11-19 19:17:40.52-03
36	admin::marketplace.plugins.install	\N	\N	[]	1	2020-11-19 19:17:40.494-03	2020-11-19 19:17:40.521-03
37	admin::marketplace.plugins.uninstall	\N	\N	[]	1	2020-11-19 19:17:40.494-03	2020-11-19 19:17:40.521-03
38	admin::webhooks.create	\N	\N	[]	1	2020-11-19 19:17:40.494-03	2020-11-19 19:17:40.521-03
39	admin::webhooks.read	\N	\N	[]	1	2020-11-19 19:17:40.494-03	2020-11-19 19:17:40.521-03
40	admin::webhooks.update	\N	\N	[]	1	2020-11-19 19:17:40.495-03	2020-11-19 19:17:40.521-03
41	admin::webhooks.delete	\N	\N	[]	1	2020-11-19 19:17:40.558-03	2020-11-19 19:17:40.573-03
42	admin::users.create	\N	\N	[]	1	2020-11-19 19:17:40.561-03	2020-11-19 19:17:40.584-03
43	admin::users.read	\N	\N	[]	1	2020-11-19 19:17:40.565-03	2020-11-19 19:17:40.59-03
44	admin::users.update	\N	\N	[]	1	2020-11-19 19:17:40.565-03	2020-11-19 19:17:40.59-03
45	admin::users.delete	\N	\N	[]	1	2020-11-19 19:17:40.566-03	2020-11-19 19:17:40.59-03
46	admin::roles.create	\N	\N	[]	1	2020-11-19 19:17:40.566-03	2020-11-19 19:17:40.59-03
47	admin::roles.read	\N	\N	[]	1	2020-11-19 19:17:40.566-03	2020-11-19 19:17:40.59-03
48	admin::roles.update	\N	\N	[]	1	2020-11-19 19:17:40.566-03	2020-11-19 19:17:40.59-03
49	admin::roles.delete	\N	\N	[]	1	2020-11-19 19:17:40.566-03	2020-11-19 19:17:40.591-03
109	plugins::content-manager.explorer.delete	application::author.author	\N	[]	1	2020-11-21 19:18:43.821-03	2020-11-21 19:18:43.855-03
53	plugins::content-manager.explorer.delete	application::landing-page.landing-page	\N	[]	1	2020-11-20 16:50:06.622-03	2020-11-20 16:50:06.641-03
54	plugins::content-manager.explorer.publish	application::landing-page.landing-page	\N	[]	1	2020-11-20 16:50:06.623-03	2020-11-20 16:50:06.641-03
110	plugins::content-manager.explorer.publish	application::author.author	\N	[]	1	2020-11-21 19:18:43.821-03	2020-11-21 19:18:43.856-03
103	plugins::content-manager.explorer.create	application::author.author	["avatar", "name", "role", "description", "socialLinks.url", "socialLinks.title"]	[]	1	2020-11-21 19:18:43.82-03	2020-11-21 19:18:43.855-03
105	plugins::content-manager.explorer.read	application::author.author	["avatar", "name", "role", "description", "socialLinks.url", "socialLinks.title"]	[]	1	2020-11-21 19:18:43.82-03	2020-11-21 19:18:43.855-03
107	plugins::content-manager.explorer.update	application::author.author	["avatar", "name", "role", "description", "socialLinks.url", "socialLinks.title"]	[]	1	2020-11-21 19:18:43.821-03	2020-11-21 19:18:43.855-03
141	plugins::content-manager.explorer.delete	application::landing-page.landing-page	\N	["admin::is-creator"]	3	2020-11-21 20:11:52.053-03	2020-11-21 20:11:52.072-03
140	plugins::content-manager.explorer.update	application::landing-page.landing-page	["header.button.label", "header.button.url", "header.description", "header.image", "header.title", "logo", "princingBox.benefits", "princingBox.button.label", "princingBox.button.url", "princingBox.numberInstallments", "princingBox.totalPrice", "sectionAboutProject.description", "sectionAboutProject.media", "sectionAboutProject.title", "sectionAboutUs.authors", "sectionAboutUs.title", "sectionAgenda.description", "sectionAgenda.title", "sectionConcepts.concepts.title", "sectionConcepts.title", "sectionFaq.questions.answer", "sectionFaq.questions.question", "sectionFaq.title", "sectionModules.modules.description", "sectionModules.modules.subtitle", "sectionModules.modules.title", "sectionModules.title", "sectionReviews.title", "sectionTech", "sectionReviews.reviews.name", "sectionReviews.reviews.text", "sectionReviews.reviews.photo", "princingBox.priceInstallment"]	["admin::is-creator"]	3	2020-11-21 20:11:52.053-03	2020-11-21 20:46:29.415-03
151	plugins::content-manager.explorer.create	application::landing-page.landing-page	["logo", "header.title", "header.description", "header.button.label", "header.button.url", "header.image", "sectionAboutProject.title", "sectionAboutProject.media", "sectionAboutProject.description", "sectionTech.title", "sectionTech.techIcons.name", "sectionTech.techIcons.icon", "sectionConcepts.title", "sectionConcepts.concepts.title", "sectionAgenda.title", "sectionAgenda.description", "princingBox.totalPrice", "princingBox.numberInstallments", "princingBox.benefits", "princingBox.button.label", "princingBox.button.url", "sectionAboutUs.title", "sectionAboutUs.authors", "sectionReviews.title", "sectionFaq.title", "sectionFaq.questions.question", "sectionFaq.questions.answer", "sectionModules.title", "sectionModules.modules.title", "sectionModules.modules.subtitle", "sectionModules.modules.description", "sectionReviews.reviews.name", "sectionReviews.reviews.text", "sectionReviews.reviews.photo", "princingBox.priceInstallment"]	[]	1	2020-11-21 20:42:54.341-03	2020-11-21 20:46:29.416-03
138	plugins::content-manager.explorer.create	application::landing-page.landing-page	["header.button.label", "header.button.url", "header.description", "header.image", "header.title", "logo", "princingBox.benefits", "princingBox.button.label", "princingBox.button.url", "princingBox.numberInstallments", "princingBox.totalPrice", "sectionAboutProject.description", "sectionAboutProject.media", "sectionAboutProject.title", "sectionAboutUs.authors", "sectionAboutUs.title", "sectionAgenda.description", "sectionAgenda.title", "sectionConcepts.concepts.title", "sectionConcepts.title", "sectionFaq.questions.answer", "sectionFaq.questions.question", "sectionFaq.title", "sectionModules.modules.description", "sectionModules.modules.subtitle", "sectionModules.modules.title", "sectionModules.title", "sectionReviews.title", "sectionTech", "sectionReviews.reviews.name", "sectionReviews.reviews.text", "sectionReviews.reviews.photo", "princingBox.priceInstallment"]	["admin::is-creator"]	3	2020-11-21 20:11:52.039-03	2020-11-21 20:46:29.416-03
139	plugins::content-manager.explorer.read	application::landing-page.landing-page	["header.button.label", "header.button.url", "header.description", "header.image", "header.title", "logo", "princingBox.benefits", "princingBox.button.label", "princingBox.button.url", "princingBox.numberInstallments", "princingBox.totalPrice", "sectionAboutProject.description", "sectionAboutProject.media", "sectionAboutProject.title", "sectionAboutUs.authors", "sectionAboutUs.title", "sectionAgenda.description", "sectionAgenda.title", "sectionConcepts.concepts.title", "sectionConcepts.title", "sectionFaq.questions.answer", "sectionFaq.questions.question", "sectionFaq.title", "sectionModules.modules.description", "sectionModules.modules.subtitle", "sectionModules.modules.title", "sectionModules.title", "sectionReviews.title", "sectionTech", "sectionReviews.reviews.name", "sectionReviews.reviews.text", "sectionReviews.reviews.photo", "princingBox.priceInstallment"]	["admin::is-creator"]	3	2020-11-21 20:11:52.039-03	2020-11-21 20:46:29.416-03
152	plugins::content-manager.explorer.read	application::landing-page.landing-page	["logo", "header.title", "header.description", "header.button.label", "header.button.url", "header.image", "sectionAboutProject.title", "sectionAboutProject.media", "sectionAboutProject.description", "sectionTech.title", "sectionTech.techIcons.name", "sectionTech.techIcons.icon", "sectionConcepts.title", "sectionConcepts.concepts.title", "sectionAgenda.title", "sectionAgenda.description", "princingBox.totalPrice", "princingBox.numberInstallments", "princingBox.benefits", "princingBox.button.label", "princingBox.button.url", "sectionAboutUs.title", "sectionAboutUs.authors", "sectionReviews.title", "sectionFaq.title", "sectionFaq.questions.question", "sectionFaq.questions.answer", "sectionModules.title", "sectionModules.modules.title", "sectionModules.modules.subtitle", "sectionModules.modules.description", "sectionReviews.reviews.name", "sectionReviews.reviews.text", "sectionReviews.reviews.photo", "princingBox.priceInstallment"]	[]	1	2020-11-21 20:42:54.342-03	2020-11-21 20:46:29.416-03
153	plugins::content-manager.explorer.update	application::landing-page.landing-page	["logo", "header.title", "header.description", "header.button.label", "header.button.url", "header.image", "sectionAboutProject.title", "sectionAboutProject.media", "sectionAboutProject.description", "sectionTech.title", "sectionTech.techIcons.name", "sectionTech.techIcons.icon", "sectionConcepts.title", "sectionConcepts.concepts.title", "sectionAgenda.title", "sectionAgenda.description", "princingBox.totalPrice", "princingBox.numberInstallments", "princingBox.benefits", "princingBox.button.label", "princingBox.button.url", "sectionAboutUs.title", "sectionAboutUs.authors", "sectionReviews.title", "sectionFaq.title", "sectionFaq.questions.question", "sectionFaq.questions.answer", "sectionModules.title", "sectionModules.modules.title", "sectionModules.modules.subtitle", "sectionModules.modules.description", "sectionReviews.reviews.name", "sectionReviews.reviews.text", "sectionReviews.reviews.photo", "princingBox.priceInstallment"]	[]	1	2020-11-21 20:42:54.342-03	2020-11-21 20:46:29.416-03
\.
...
1	Super Admin	strapi-super-admin	Super Admins can access and manage all features and settings.	2020-11-19 19:17:40.167-03	2020-11-19 19:17:40.167-03
2	Editor	strapi-editor	Editors can manage and publish contents including those of other users.	2020-11-19 19:17:40.19-03	2020-11-19 19:17:40.19-03
3	Author	strapi-author	Authors can manage the content they have created.	2020-11-19 19:17:40.208-03	2020-11-19 19:17:40.208-03
\.
...
95	7	5	authors	avatar	1
96	6	4	authors	avatar	1
97	8	7	authors	avatar	1
132	29	1	components_page_headers	image	1
133	28	1	components_page_section_about_projects	media	1
134	2	1	components_page_tech_icons	icon	1
135	22	2	components_page_tech_icons	icon	1
136	21	3	components_page_tech_icons	icon	1
137	26	4	components_page_tech_icons	icon	1
138	27	5	components_page_tech_icons	icon	1
139	19	6	components_page_tech_icons	icon	1
140	20	7	components_page_tech_icons	icon	1
141	23	8	components_page_tech_icons	icon	1
142	24	9	components_page_tech_icons	icon	1
143	18	10	components_page_tech_icons	icon	1
144	4	1	components_page_reviews	photo	1
145	15	2	components_page_reviews	photo	1
146	16	3	components_page_reviews	photo	1
147	12	4	components_page_reviews	photo	1
148	30	1	landing_pages	logo	1
\.
...
177	content-manager	contentmanager	findrelationlist	f		1	\N	\N
178	content-manager	contentmanager	findrelationlist	f		2	\N	\N
179	content-manager	contentmanager	publish	f		1	\N	\N
180	content-manager	contentmanager	publish	f		2	\N	\N
181	content-manager	contentmanager	unpublish	f		1	\N	\N
182	content-manager	contentmanager	unpublish	f		2	\N	\N
\.
...
--
-- Name: components_page_models_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.components_page_models_id_seq', 1, false);
...
--
-- Name: components_page_princing_boxes_components_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.components_page_princing_boxes_components_id_seq', 1, true);


--
-- Name: components_page_princing_boxes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.components_page_princing_boxes_id_seq', 1, true);
...
--
-- Name: components_page_section_models_components_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.components_page_section_models_components_id_seq', 1, false);


--
-- Name: components_page_section_models_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.components_page_section_models_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.strapi_permission_id_seq', 153, true);
...
SELECT pg_catalog.setval('public.upload_file_morph_id_seq', 148, true);
...
SELECT pg_catalog.setval('public."users-permissions_permission_id_seq"', 182, true);
...
--
-- Name: components_page_models components_page_models_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_models
    ADD CONSTRAINT components_page_models_pkey PRIMARY KEY (id);
...
--
-- Name: components_page_princing_boxes_components components_page_princing_boxes_components_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_princing_boxes_components
    ADD CONSTRAINT components_page_princing_boxes_components_pkey PRIMARY KEY (id);


--
-- Name: components_page_princing_boxes components_page_princing_boxes_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_princing_boxes
    ADD CONSTRAINT components_page_princing_boxes_pkey PRIMARY KEY (id);
...
--
-- Name: components_page_section_models_components components_page_section_models_components_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_section_models_components
    ADD CONSTRAINT components_page_section_models_components_pkey PRIMARY KEY (id);


--
-- Name: components_page_section_models components_page_section_models_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_section_models
    ADD CONSTRAINT components_page_section_models_pkey PRIMARY KEY (id);
...
--
-- Name: components_page_princing_boxes_components components_page_princing_box_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_princing_boxes_components
    ADD CONSTRAINT components_page_princing_box_id_fk FOREIGN KEY (components_page_princing_box_id) REFERENCES public.components_page_princing_boxes(id) ON DELETE CASCADE;
...
--
-- Name: components_page_section_models_components components_page_section_model_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.components_page_section_models_components
    ADD CONSTRAINT components_page_section_model_id_fk FOREIGN KEY (components_page_section_model_id) REFERENCES public.components_page_section_models(id) ON DELETE CASCADE;
